...
let API_LOCAL = "http://localhost:3000",
  API_PRODUCTION = "https://bagram-backend.herokuapp.com";
...
module.exports = function(/* ctx */) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: `Bagram - Zdielaj Bratislavu`,
        short_name: `Bagram`,
        description: `Jednoducha aplikacia inspirovana Instagramom vyrobena s Quasar.`,
        display: "standalone",
